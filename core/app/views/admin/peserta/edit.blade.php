...
{{-- Content --}}
@section('content')
{{ Form::open(['route' => 'update.peserta', 'autocomplete'=>'off','class'=>'form-horizontal']) }}
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group {{ $errors->has('kegiatan_id') ? 'has-error' : '' }}">
                ...
                <select id="select2" size="1" class="form-control" id="kegiatan_id" name="kegiatan_id">
                    ...
                    <option value="{{$item->id}}"
                        {{ $item->id == $peserta->kegiatan_id ? 'selected="selected"' : '' }}>{{$item->nama_kegiatan}}
                    </option>
                    @endforeach
                </select>
            ...
            <div class="form-group {{ $errors->has('no_sertifikat') ? 'has-error' : '' }}">
                ...
                <input value="{{ $peserta->no_sertifikat }}" type="text" class="form-control" id="no_sertifikat"
                    name="no_sertifikat">
            ...
            <div class="form-group {{ $errors->has('sebagai') ? 'has-error' : '' }}">
                ...
                <input value="{{ $peserta->sebagai }}" type="text" class="form-control" id="sebagai"
                    name="sebagai">
            ...
            <div class="form-group {{ $errors->has('nama_lengkap') ? 'has-error' : '' }}">
                ...
                <input value="{{ $peserta->nama_lengkap }}" type="text" class="form-control" id="nama_lengkap"
                    name="nama_lengkap">
                {{ $errors->first('nama_lengkap', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('jk') ? 'has-error' : '' }}">
                <label for=" exampleInputEmail1">Jenis Kelamin</label>
                <input value="{{ $peserta->jk }}" type="text" class="form-control" id="jk"
                    name="jk">
            ...
            <div class="form-group {{ $errors->has('instansi') ? 'has-error' : '' }}">
                ...
                <input value="{{ $peserta->instansi }}" type="text" class="form-control" id="instansi" name="instansi">
                {{ $errors->first('instansi', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('jabatan') ? 'has-error' : '' }}">
                <label for="exampleInputEmail1">Jabatan</label>
                <input value="{{ $peserta->jabatan }}" type="text" class="form-control" id="jabatan" name="jabatan">
                {{ $errors->first('jabatan', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('no_hp') ? 'has-error' : '' }}">
                <label for="exampleInputEmail1">No HP</label>
                <input value="{{ $peserta->no_hp }}" type="text" class="form-control" id="no_hp" name="no_hp">
                {{ $errors->first('no_hp', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                <label for="exampleInputEmail1">Email</label>
                <input value="{{ $peserta->email }}" type="email" class="form-control" id="email" name="email">
                {{ $errors->first('email', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('alamat') ? 'has-error' : '' }}">
                <label for="exampleInputEmail1">Alamat</label>
                <input value="{{ $peserta->alamat }}" type="text" class="form-control" id="alamat"
                    name="alamat">
            ...
            <div class="form-group {{ $errors->has('kabkota') ? 'has-error' : '' }}">
                ...
                <input value="{{ $peserta->kabkota }}" type="text" class="form-control" id="kabkota" name="kabkota">
                {{ $errors->first('kabkota', '<small class="help-block text-danger">:message</small>') }}
            </div>
            <div class="form-group {{ $errors->has('provinsi') ? 'has-error' : '' }}">
                <label for="exampleInputEmail1">Provinsi</label>
                <input value="{{ $peserta->provinsi }}" type="text" class="form-control" id="provinsi" name="provinsi">
